...
<template>
  <div class="flex-col items-start page">
    ...
    <div class="image-container">
      ...
      <div class="text-overlay">
        <h1 class="title"><em2>智邮卫盾</em2></h1>
        <p class="description">
          <em>智能守护，安全无忧<br><br>
          在信息时代，钓鱼邮件如影随形，威胁着我们的网络安全<br>
          智邮卫盾，凭借先进的算法和深度学习技术，为您构筑一道坚实的安全屏<br>
          以高精度识别技术，实时检测可疑邮件，过滤潜在风险<br>
          为您守护每一封邮件，保障每一份安心</em><br><br>
          <em>智邮卫盾，您的智能安全卫士</em>
        </p>
      </div>
    </div>
...
<style scoped lang="css">
  ...
  em {
    ...
    animation: fadeInZoom 1.5s ease-in-out forwards; /* 动态效果 */
  }
